...
# create-react-app = react + webpack + babel

# created using
npm install -g create-react-app
create-react-app cd myapp

# pull your application out of the context of the create-react-app framework and into a standard webpack build
yarn run eject
