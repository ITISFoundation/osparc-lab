...
def check_menu( key_word = "Risotto", day = 0, verbose = False ):
	...
	run_for_lunch = 0
	try:
		url = "https://gastro.lunchgate.ch/widget.php?type=standardpremium&id=652&day=" + str(day)
		...
		try:
			...
			all_cells = [td.get_text() for td in table.find("tr").find_all("td")]
...
if __name__=='__main__':
	if len(sys.argv) < 3:
		...
		oggi = check_menu(key_word = sys.argv[1], day = sys.argv[2], verbose = False)
		print oggi
